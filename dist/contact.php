    ...
    <div class="container">
        <div class="contact-info">
            <div class="contact-info-block_1">
                ...
                <p class="contact-info__text">И ПО НОМЕРУ: <span class="contact-info__text_bold"><a href="#" class="contact-info__tel">+3 8 044 288 58 88</a>, <a href="#" class="contact-info__tel">+3 8 050 416 77 22</a></span></p>
